...
## Load in data
data = xr.open_dataset('/Users/fridaperez/Developer/repos/phase_project/Retreat/Mean_Files/2012_23_mean_xr_15p.nc')
...
cbar.set_label('DAYS SINCE AUGUST',color='black')
cbar.ax.tick_params(axis='x', colors='black')

plt.savefig('/Users/fridaperez/Desktop/Proposal/Proposal_Figures/Retreat_mean12-22_white.png', dpi=500)