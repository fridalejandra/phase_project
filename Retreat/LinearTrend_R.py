...
time_da = pd.date_range(start=pd.Timestamp(2012, 1, 1), periods=12, freq='A-AUG')

ds = xr.open_mfdataset('/Users/fridaperez/Developer/repos/phase_project/Retreat/nan/nan_20*_R_5d_15p.nc', preprocess=add_time_dim, combine='nested',concat_dim='time')
...
cbar.set_label('DAY OF RETREAT TREND',fontsize=14)
...
#plt.savefig('/Users/fridaperez/Desktop/Proposal/Proposal_Figures/R_Trend_12-23_white.png', bbox_inches="tight", dpi=500)
