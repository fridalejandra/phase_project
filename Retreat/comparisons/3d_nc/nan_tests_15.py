...
dir = '/Users/fridaperez/Developer/repos/phase_project/Retreat/comparisons/3d_nc/'
count = 0
files = []
for i in os.listdir(dir):
    if i.endswith('.nc'):
       ...
       # BU_nan[BU_nan == 1.0] = np.nan
        ...
        mir = '/Users/fridaperez/Developer/repos/phase_project/Retreat/comparisons/3d_nan/'
