...
# Calculate Spearmans correlation coefficient with NaN handling
r = xs.spearman_r(var_R, var_A, dim='time', skipna=True)
print("Spearmans Correlation Coefficient (r):", r)

# P-Value
pval = xs.spearman_r_p_value(var_R,var_A,dim='time',skipna=True)
...
#ct = m.contourf(x_bu, y_bu, pval_95, levels=[0, 0.05], hatches=['////'], extend='both') #colors='green'
...
# Save the figure after printing the correlation and confidence interval
plt.savefig('/Users/fridaperez/Desktop/Proposal/Proposal_Figures/Spearmans_R_Pval_black_inverse.png', bbox_inches="tight", dpi=500)
