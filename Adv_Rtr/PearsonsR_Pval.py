...
r = xs.pearson_r(var_R, var_A, dim='time', skipna=True)
print("Pearson Correlation Coefficient (r):", r)

# P-Value
pval = xs.pearson_r_p_value(var_R,var_A,dim='time',skipna=True)
...
plt.savefig('/Users/fridaperez/Desktop/Proposal/Proposal_Figures/Pearsons_R_Pval_black_inverse.png', bbox_inches="tight", dpi=500)
